<template>
  ...
  >
    ...
    <g filter="url(#filter0_d_1544_8231)">
      <rect x="85" y="62" width="100" height="68" rx="2" fill="var(--el-bg-color-overlay)"></rect>
      <rect
        x="84.7"
        y="61.7"
        width="100.6"
    ...
    <rect x="93" y="74" width="25" height="4" rx="2" fill="var(--el-border-color-dark)"></rect>
    <path
    ...
    ></path>
    <rect x="93" y="94" width="25" height="4" rx="2" fill="var(--el-color-primary)"></rect>
    <rect x="93" y="114" width="25" height="4" rx="2" fill="var(--el-border-color-dark)"></rect>
    <defs>
      <filter
